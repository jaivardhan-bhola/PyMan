...
spriteRatio = 3/2
square = 19 # Size of each unit square
...
pygame.display.set_icon(pygame.image.load('Assets/ElementImages/tile052.png'))
pygame.display.flip()
...
def displayLaunchScreen():
    ...
    musicPlaying = 1
    # Draw Pacman Title
    pacmanTitle = ["tile016.png", "tile025.png","tile012.png", "tile000.png", "tile013.png"]
    for i in range(len(pacmanTitle)):
        ...
        screen.blit(letter, ((4 + 4 * i) * square, 2 * square, square, square))
